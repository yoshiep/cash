...
<h6 class="m-0 font-weight-bold text-primary">Tabungan:</h6>
            ...
            <div class="card-body">
              ...
              <div class="col-sm-2">
              <label>Nominal:</label>
                <input class="form-control form-control-sm" type="number"   aria-label=".form-control-sm example" name='jumlah' required>
              </div>
              ...
              <button type="submit" class="btn btn-primary btn-lg btn-block mt-4" name='kirim'>Tabung</button>
              ...
              <?php
               ...
               $wet =mysqli_query($conn, "select * from tabungan where nama ='$nama' ");
               ...
               $insert = mysqli_query($conn, "INSERT INTO tabungan(nama,jumlah,tanggal) VALUES (
                '$nama',
                '$jumlah',
                '$date'
                  )");
