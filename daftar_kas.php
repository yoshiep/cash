        ...
        <div class="container-fluid">
                       ...
                       <h6 class="m-0 font-weight-bold text-primary">Data Pemasukan Kas:</h6>
                                    ...
                                    <div class="card-body">
                                      ...
                                      $jumlah_cos=mysqli_query($conn,"SELECT COUNT(*) as id from kas where tahun=year(CURRENT_DATE) ");
                    ...
                    if(isset($_GET['hapus'])){
                       ...
                       echo "</div>";
                                       ...
                                       <thead>
                                         <tr>
                                           <th scope="col">No</th>
                                           <th scope="col">Tahun Kas</th>
                                           <th scope="col">Bulan Kas</th>
                                     ...
                                     if(mysqli_num_rows($brg) > 0){
                                        ...
                                        $brg=mysqli_query($conn, "select * from kas where tahun=year(CURRENT_DATE) limit $start, $hal");
                                      }
