...
<h6 class="m-0 font-weight-bold text-primary">Setor Uang Kas:</h6>
            ...
            <div class="card-body">
              ...
              <label>Uang Kas:</label>
                <input class="form-control form-control-sm" type="number" value=50000  aria-label=".form-control-sm example" name='jumlah' required>
                 </fieldset>
              </div>

              <div class="col-sm-2">
              <label>Tahun Iuran:</label>
                <input class="form-control form-control-sm" type="number"  placeholder="Tahun Iuran..." aria-label=".form-control-sm example" name='tahun' required>
              </div>
              ...
              ?>
                <option value="<?php echo $LabelBulan;?>"><?php echo $LabelBulan;?></option>
                <?php }?>
              </select>
              </div>
              ...
              <button type="submit" class="btn btn-primary btn-lg btn-block mt-4" name='kirim'>Bayar</button>
              ...
              <?php
               ...
               $bulan1 = htmlspecialchars($_POST['bulan']);
               $levelw = 1;

               $wet =mysqli_query($conn, "select * from kas where nama ='$nama' and tahun='$tahun' and bulan='$bulan1'");
