      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <?php
            ...
            $det=mysqli_query($conn, "select * from tabungan where id='$id_brg'");
            while($d=mysqli_fetch_array($det)){
            ?>
          <div class="card shadow  ml-4 mr-4">
            <!-- Card Header - Dropdown -->
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary">Edit Data Tabungan:</h6>
            </div>
        ...
        <?php
          ...
          if(isset($_POST['edit'])){
           ...
           $Jumlah_kas=mysqli_query($conn, "select sum(jumlah) as kas from tabungan");
           $total=mysqli_fetch_array($Jumlah_kas);
           $total_kas = ($total['kas']);


             $Jumlah_out=mysqli_query($conn, "select sum(jumlah) as keluar from tabungan");
         ...
         $edit = mysqli_query($conn, "UPDATE tabungan SET
        nama ='$nama',
        jumlah ='$jumlah',
        tanggal ='$tanggal'
        WHERE id ='".$_GET['id']."'
