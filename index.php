...
include 'config/koneksi.php';
  ...
  $Jumlah_tabungan=mysqli_query($conn, "select sum(jumlah) as tab from tabungan ");
  $total_tabungan=mysqli_fetch_array($Jumlah_tabungan);
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="catat_tabung.php">Catat Tabungan</a>
            <a class="collapse-item" href="daftar_out.php">Daftar Pengeluaran</a>
            <a class="collapse-item" href="daftar_tabungan.php">Daftar Tabungan</a>
          </div>
        </div>
      </li>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Jumlah Tabungan</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo "Rp.".number_format($total_tabungan['tab']); ?></div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-credit-card fa-2x text-gray-300"></i>
                    </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Jumlah Item Pengeluaran</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jum_keluar." Acara"; ?></div>
                    </div>
                    <div class="col-auto">
            ...
            <?php
              $sisa=$total['kas']+$total_tabungan['tab']-$total_out['keluar'];
            ?>
             <!-- Pending Requests Card Example -->
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-danger  shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Sisa Uang Kas</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo "Rp.".number_format($sisa); ?></div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-chart-bar fa-2x text-gray-300"></i>
                    </div>
