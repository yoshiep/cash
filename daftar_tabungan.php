...
<h6 class="m-0 font-weight-bold text-primary">Data Tabungan:</h6>
            ...
            <div class="card-body">
              ...
              $jumlah_cos=mysqli_query($conn,"SELECT COUNT(*) as id from tabungan");
       ...
       <h7 class="m-0 font-weight-bold">List Tabungan Di Tabel: <?php echo $kap." Max"; ?></h7><br>
...
echo "</div>";
               ...
               if(isset($_GET['cari'])){
                ...
                $brg=mysqli_query($conn, "select * from tabungan where id like '%".$cari."%' or nama like '%".$cari."%'");
             ...
             if(mysqli_num_rows($brg) > 0){
                ...
                $brg=mysqli_query($conn, "select * from tabungan limit $start, $hal");
              }
             ...
             if(mysqli_num_rows($brg)){
               ...
               <tbody>
                 <tr>
                   ...
                   <td>&nbsp;<a href="edit_tabungan.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">Edit</button></a> &nbsp; <a href="hapus_tabungan.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-danger">Hapus</button></a> &nbsp;</td>
